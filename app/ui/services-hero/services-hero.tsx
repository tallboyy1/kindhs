      ...
      <div className="relative">
        ...
        <div className="w-full md:w-11/12 flex flex-col mx-auto text-center relative md:top-0 justify-center md:flex md:flex-row md:justify-around gap-8 items-center h-full pt-32 pb-10 md:pt-40 md:pb-16 lg:pt-40 lg:pb-16">
          <div className="w-72 tiny:w-80 md:w-96">
            <h1 className="text-3xl md:text-2xl lg:text-4xl my-3 text-left text-blue font-semibold">Comprehensive home care services</h1>
            <p className={"text-xs text-blue text-left font-light"}>Discover a range of services designed to provide compassionate and professional care in the comfort of your home.</p>
          </div>
          <div className="w-72 tiny:w-80 md:w-96">
            <Image
